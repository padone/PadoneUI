...
function saveArticleID(num){
	...
	sessionStorage.setItem('familydepartmentarticleid', str);
	sessionStorage.setItem('familydepartmentauthor', author);
	window.location.href="FamilyDepartmentArticleSide.html";
}